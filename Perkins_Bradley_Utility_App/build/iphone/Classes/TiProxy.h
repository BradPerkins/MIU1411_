...
//Rare exceptions to indicate a bug in the _perkins_bradley_utility_app code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Perkins_Bradley_Utility_App proxies.
 */
