...
// in simulator we redefine to format for Perkins_Bradley_Utility_App Developer console
...
{\
	NSString * exceptionName = [@"org.perkins_bradley_utility_app." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.perkins_bradley_utility_app";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIPerkins_Bradley_Utility_AppNativeItemNone = -1, 
	UIPerkins_Bradley_Utility_AppNativeItemSpinner = -2,
	UIPerkins_Bradley_Utility_AppNativeItemProgressBar = -3,
	
	UIPerkins_Bradley_Utility_AppNativeItemSlider = -4,
	UIPerkins_Bradley_Utility_AppNativeItemSwitch = -5,
	UIPerkins_Bradley_Utility_AppNativeItemMultiButton = -6,
	UIPerkins_Bradley_Utility_AppNativeItemSegmented = -7,
	
	UIPerkins_Bradley_Utility_AppNativeItemTextView = -8,
	UIPerkins_Bradley_Utility_AppNativeItemTextField = -9,
	UIPerkins_Bradley_Utility_AppNativeItemSearchBar = -10,
	
	UIPerkins_Bradley_Utility_AppNativeItemPicker = -11,
	UIPerkins_Bradley_Utility_AppNativeItemDatePicker = -12,
	
	UIPerkins_Bradley_Utility_AppNativeItemInfoLight = -13,
	UIPerkins_Bradley_Utility_AppNativeItemInfoDark = -14,
	
	UIPerkins_Bradley_Utility_AppNativeItemDisclosure = -15,
	
	UIPerkins_Bradley_Utility_AppNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Perkins_Bradley_Utility_App instances of
