...
@interface Perkins_Bradley_Utility_AppObject : KrollCoverageObject {
#else
@interface Perkins_Bradley_Utility_AppObject : KrollObject {
#endif
@private
...
extern NSString * Perkins_Bradley_Utility_App$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Perkins_Bradley_Utility_AppObject *_perkins_bradley_utility_app;
    KrollObject* console;
	BOOL shutdown;
