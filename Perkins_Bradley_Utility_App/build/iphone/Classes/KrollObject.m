...
//@interface Perkins_Bradley_Utility_AppObject : NSObject
//@end

@interface Perkins_Bradley_Utility_AppObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Perkins_Bradley_Utility_AppObject class]])
		{
			for (NSString *key in [[(Perkins_Bradley_Utility_AppObject*)o modules] allKeys])
			{
