...
/**
 Base class for all Perkins_Bradley_Utility_App views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Perkins_Bradley_Utility_App view hierarchy (such as wrapped iOS UIViews) was touched.
