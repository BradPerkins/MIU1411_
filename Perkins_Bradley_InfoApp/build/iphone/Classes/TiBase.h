...
// in simulator we redefine to format for InformationalApp Developer console
...
{\
	NSString * exceptionName = [@"org.informationalapp." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.informationalapp";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIInformationalAppNativeItemNone = -1, 
	UIInformationalAppNativeItemSpinner = -2,
	UIInformationalAppNativeItemProgressBar = -3,
	
	UIInformationalAppNativeItemSlider = -4,
	UIInformationalAppNativeItemSwitch = -5,
	UIInformationalAppNativeItemMultiButton = -6,
	UIInformationalAppNativeItemSegmented = -7,
	
	UIInformationalAppNativeItemTextView = -8,
	UIInformationalAppNativeItemTextField = -9,
	UIInformationalAppNativeItemSearchBar = -10,
	
	UIInformationalAppNativeItemPicker = -11,
	UIInformationalAppNativeItemDatePicker = -12,
	
	UIInformationalAppNativeItemInfoLight = -13,
	UIInformationalAppNativeItemInfoDark = -14,
	
	UIInformationalAppNativeItemDisclosure = -15,
	
	UIInformationalAppNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all InformationalApp instances of
