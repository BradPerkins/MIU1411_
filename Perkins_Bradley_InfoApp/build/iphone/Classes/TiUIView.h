...
/**
 Base class for all InformationalApp views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the InformationalApp view hierarchy (such as wrapped iOS UIViews) was touched.
