...
//Rare exceptions to indicate a bug in the _informationalapp code (Eg, function that a subclass should have implemented)
...
/**
 The base class for InformationalApp proxies.
 */
