...
@interface InformationalAppObject : KrollCoverageObject {
#else
@interface InformationalAppObject : KrollObject {
#endif
@private
...
extern NSString * InformationalApp$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	InformationalAppObject *_informationalapp;
    KrollObject* console;
	BOOL shutdown;
