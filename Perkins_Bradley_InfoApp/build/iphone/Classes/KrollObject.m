...
//@interface InformationalAppObject : NSObject
//@end

@interface InformationalAppObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[InformationalAppObject class]])
		{
			for (NSString *key in [[(InformationalAppObject*)o modules] allKeys])
			{
