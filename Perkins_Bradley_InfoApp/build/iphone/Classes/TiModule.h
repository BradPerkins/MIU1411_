...
/**
 The base class for all InformationalApp modules
 */
...
/**
 InformationalApp Platform calls this method on startup.
 */
-(void)startup;

/**
 InformationalApp Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 InformationalApp Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 InformationalApp Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 InformationalApp Platform calls this method on resume.
 @param sender The sender of the event.
 */
