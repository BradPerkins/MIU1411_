...
// in simulator we redefine to format for aboutme Developer console
...
{\
	NSString * exceptionName = [@"org.aboutme." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.aboutme";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIaboutmeNativeItemNone = -1, 
	UIaboutmeNativeItemSpinner = -2,
	UIaboutmeNativeItemProgressBar = -3,
	
	UIaboutmeNativeItemSlider = -4,
	UIaboutmeNativeItemSwitch = -5,
	UIaboutmeNativeItemMultiButton = -6,
	UIaboutmeNativeItemSegmented = -7,
	
	UIaboutmeNativeItemTextView = -8,
	UIaboutmeNativeItemTextField = -9,
	UIaboutmeNativeItemSearchBar = -10,
	
	UIaboutmeNativeItemPicker = -11,
	UIaboutmeNativeItemDatePicker = -12,
	
	UIaboutmeNativeItemInfoLight = -13,
	UIaboutmeNativeItemInfoDark = -14,
	
	UIaboutmeNativeItemDisclosure = -15,
	
	UIaboutmeNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all aboutme instances of
