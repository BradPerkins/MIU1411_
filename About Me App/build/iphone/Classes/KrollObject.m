...
//@interface aboutmeObject : NSObject
//@end

@interface aboutmeObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[aboutmeObject class]])
		{
			for (NSString *key in [[(aboutmeObject*)o modules] allKeys])
			{
